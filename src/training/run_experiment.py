...
def _setup_parser():
    ...
    data_class = _import_class(f"src.app.data.{temp_args.data_class}")
    model_class = _import_class(f"src.app.models.{temp_args.model_class}")
...
def main():
    ...
    data_class = _import_class(f"src.app.data.{args.data_class}")
    model_class = _import_class(f"src.app.models.{args.model_class}")
